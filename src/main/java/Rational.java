public class Rational
{
    ...
    {
        int common_factor = greatestCommonFactor(r.numerator, r.denominator);
        int newNumerator = r.numerator/common_factor;
        int newDenominator = r.denominator/common_factor;
        Rational x = new Rational(newNumerator, newDenominator);
        return x;
    }
